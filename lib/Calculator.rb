...
# like to use (addition, subtraction, multiplication, division) and then asks the
# user for two numbers, returning the result of the method with the two numbers.
